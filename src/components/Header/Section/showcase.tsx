        ...
        <div className='zelda-clone-wrapper'>
            <div className='titles'>
                ...
                <div className='zelda-clone__sub-title'>
                    This project takes inspiration from Legend of Zelda - A Link to the Past, a classic game from the 90s. The game is a top-down shooter where the player must navigate through a maze
                    of enemies and obstacles to reach the end of the level. The game is built using Phaser.js, React.js and TypeScript.
                    <br />
                    <br />
