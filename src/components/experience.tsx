      ...
      <div className='timeline-wrapper'>
        <div className='timeline-block timeline-block-left'>
          ...
          <div className='timeline-content'>
            ...
            <p>
              Created semi-automated Excel documents for sales & stock overview
              connected with internal ERP system. Developed an automated system
              of price checking using Google App Scripts & Sheets.
            </p>
          </div>
        </div>
        {/* - */}
