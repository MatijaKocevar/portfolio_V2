...
export class Shields {
	...
	createShields = (width: number) => {
		...
		this.shieldArray.push(new ShieldBlock({ x: shieldSpacing + shieldWidth + shieldSpacing, y: 500, game }));
		this.shieldArray.push(new ShieldBlock({ x: shieldSpacing + 2 * shieldWidth + 2 * shieldSpacing, y: 500, game }));
		this.shieldArray.push(new ShieldBlock({ x: shieldSpacing + 3 * shieldWidth + 3 * shieldSpacing, y: 500, game }));
	};
