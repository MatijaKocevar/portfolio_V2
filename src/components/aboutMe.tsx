    ...
    <Row className='about-content'>
      ...
      <Col className='description' xs={12} sm={12} md={12} lg={7}>
        <p>
          ...
          clean, maintainable, and well-documented code (because let's face it, no one wants to inherit a mess of spaghetti code). In addition to my
          technical skills, I like to think I have a pretty good sense of humor (but I'll let you be the judge of that). When I'm not coding, you can
          usually find me watching funny cat videos on YouTube or cracking terrible puns (I apologize in advance).
          <br />
          <br />
