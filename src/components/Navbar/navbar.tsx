...
const NavBar = () => {
    ...
    const cvPath =
        language === "slo"
            ? "https://drive.google.com/file/d/1jaBIOPSLDQCRHbTuxoXx-LdMQTc2aV_X/view?usp=sharing"
            : "https://drive.google.com/file/d/1CCn372ynZq_tozuIVNyZDmobCHEF5jvK/view?usp=sharing";
