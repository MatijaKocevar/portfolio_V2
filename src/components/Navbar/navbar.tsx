...
const NavBar = () => {
    ...
    const cvPath =
        language === "slo"
            ? "https://drive.google.com/file/d/13kud7hm8aIxRa6Mb4_n4xdMloNwzdpkY/view?usp=sharing"
            : "https://drive.google.com/file/d/18qavOy32L7A8KWOlLjE9NMW8ULCTEP4b/view?usp=sharing";
