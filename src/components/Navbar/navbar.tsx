...
const NavBar = () => {
    ...
    const cvPath =
        language === "slo"
            ? "https://drive.google.com/file/d/1vSS5OTdB9KEzmG9WseeRedKfzEHVtVJJ/view?usp=sharing"
            : "https://drive.google.com/file/d/1a7A1h59XqKjEQ6zNjrlA5oWAMhsIqi1n/view?usp=sharing";
